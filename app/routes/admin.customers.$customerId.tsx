...
export default function CustomerDetails() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow mb-6 p-6">
        <h2 className="text-xl font-semibold mb-4">Legal Representative Information</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-500">Full Name</label>
            <p className="mt-1">{customer.legalRepName || 'Not provided'}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-500">CPF</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-500">Nationality</label>
            <p className="mt-1">{customer.legalRepNationality || 'Not provided'}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-500">Relationship to Patient</label>
            <p className="mt-1">{customer.legalRepRelationship || 'Not provided'}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-500">Email</label>
            <p className="mt-1">{customer.legalRepEmail || 'Not provided'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow mb-6 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-500">Name for Invoice</label>
            <p className="mt-1">{customer.invoiceName || 'Same as legal representative'}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-500">CPF/CNPJ</label>
            <p className="mt-1">{customer.invoiceCpfCnpj || 'Same as legal representative'}</p>
          </div>
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-500">Address</label>
            <p className="mt-1">{customer.invoiceAddress || 'Same as legal representative'}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-500">Email</label>
            <p className="mt-1">{customer.invoiceEmail || 'Same as legal representative'}</p>
          </div>
        </div>
      </div>
      ...
      {/* Billing Emails */}
      <div className="bg-white rounded-lg shadow mb-6 p-6">
        <h2 className="text-xl font-semibold mb-4">Monthly Invoice Recipients</h2>
        <div>
          ...
          {customer.billingEmails && customer.billingEmails.length > 0 ? (
            ...
            <p className="mt-1 text-gray-700">No billing emails specified</p>
          )}
        </div>
      </div>
